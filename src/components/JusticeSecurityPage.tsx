...
interface JusticeSecurityPageProps {
  onBack: () => void;
...
export function JusticeSecurityPage({ onBack, onNavigate, isAuthenticated, hasSevisPass, onLogin }: JusticeSecurityPageProps) {
  ...
  const services = [
    {
      ...
      requirements: ['SEVIS Pass', 'Valid National ID', 'Passport photo', 'Birth certificate', 'Proof of address'],
    ...
    <div className="min-h-screen bg-background flex flex-col">
      <div className="flex-1 pt-8 sm:pt-12 pb-8 sm:pb-12">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-6">
            <div>
              <h1 className="text-2xl sm:text-3xl font-bold mb-4">Justice & Security Services</h1>
              <p className="text-muted-foreground leading-relaxed">
                Access justice and security services including police clearances and legal support.
              </p>
            </div>
                    ...
                    <CardContent className="space-y-4">
                      ...
                      <Button 
                        onClick={() => {
                          ...
                          // Navigate to detailed application for police clearance
                          if (service.id === 'police-clearance') {
                            onNavigate('police-clearance-form');
                            return;
                          }
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <ul className="text-sm text-muted-foreground space-y-1">
                      <li>• SEVIS Pass required for ID verification services</li>
