...
import { Calendar, AlertTriangle, Plane } from 'lucide-react';
...
export function ImmigrationPage({ onBack, onNavigate, isAuthenticated, hasSevisPass, onLogin }: ImmigrationPageProps) {
  ...
  const services = [
    {
      ...
      description: 'Apply for a Papua New Guinea passport or travel document online with secure verification.',
      icon: Plane,
      fee: 'K100.00',
      processingTime: '3+ weeks',
      requirements: ['SEVIS Pass', 'Birth certificate', 'Citizenship evidence', 'Passport photos', 'Marriage certificate (if applicable)'],
    ...
    <div className="min-h-screen bg-background flex flex-col">
      <div className="flex-1 pt-8 sm:pt-12 pb-8 sm:pb-12">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-6">
            <div>
              <h1 className="text-2xl sm:text-3xl font-bold mb-4">Immigration & Passport Services</h1>
              <p className="text-muted-foreground leading-relaxed">
                Access passport applications and travel documents for international travel and citizenship documentation.
              </p>
            </div>
                    ...
                    <CardContent className="space-y-4">
                      ...
                      <Button 
                        onClick={() => {
                          ...
                          // Navigate to detailed application for passport
                          if (service.id === 'passport-application') {
                            onNavigate('passport-application-form');
                            return;
                          }
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <ul className="text-sm text-muted-foreground space-y-1">
                      <li>• SEVIS Pass required for all passport and ID verification services</li>
                      <li>• Passport applications must be submitted at least 3 weeks before travel</li>
                      <li>• Valid supporting documents and certificates required</li>
